<template>
    <TransitionRoot :show="isOpen" as="template">
      ...
      >
        ...
        >
          <div
            class="fixed inset-0 bg-gray-900/50 backdrop-filter backdrop-blur-sm"
          />
        </TransitionChild>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  class="px-4 py-3 flex justify-end space-x-3 border-t border-gray-100"
                  v-if="$slots.footer"
                >
  ...
  <script>
  import Icon from "@/components/icons/IconGeneral.vue";
